...
function setRequestHeader() {
  ...
  // comgheader=appconfigid
  header['comgheader'] = app.globalData.configid;
...
function checkRequest(url, param = {}, success, failed, complete) {
  ...
  // param.userid='1a5b195e-7e7c-46db-bbc8-58dadc45988f';
  wx.request({
    url: url,
    data: param,
    ...
    success: function (res) {
      if (res.statusCode == 200) {
        ...
        if (url.indexOf('wechat-mp/oauth') > -1&&data.code==0) {
